...
namespace Metro_WInForm  //img size 77;140      2 = classic blindpick   4 = ranked solo/duo 14 = classic draft pick  61 = team builder     42 = 5v5 ranked  65=aram 
{
    public partial class Main : MetroForm
    {
        ...
        public Main()
        {
            ...
            SaveChechBox.Checked = Metro_WInForm.Properties.Settings.Default.SaveCheckBox;

            if (Metro_WInForm.Properties.Settings.Default.SummonerCB == true)
            {
            ...
            regionsComboBox.SelectedIndex = Metro_WInForm.Properties.Settings.Default.RegionIndex;

            TextBoxSummonerName.Text = Metro_WInForm.Properties.Settings.Default.SummonerName;
        }
        ...
        private void SaveSettings()
        {
            ...
            {
                Metro_WInForm.Properties.Settings.Default.SaveCheckBox = true;
                Metro_WInForm.Properties.Settings.Default.SummonerName = TextBoxSummonerName.Text;
            }
            else
            {
                Metro_WInForm.Properties.Settings.Default.SaveCheckBox = false;
                Metro_WInForm.Properties.Settings.Default.SummonerName = string.Empty;
            }

            // type of search
            if (SummonerCheckBox.Checked)
                Metro_WInForm.Properties.Settings.Default.SummonerCB = true;
            else
                Metro_WInForm.Properties.Settings.Default.SummonerCB = false;


            //ComboBox
            Metro_WInForm.Properties.Settings.Default.RegionIndex = regionsComboBox.SelectedIndex;

            Metro_WInForm.Properties.Settings.Default.Save();
        }
        ...
        public void SearchSummoner(string Summoner)
        {
            ...
            else
            {
                try
                {
                    ...
                    Image DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.provisional);
                    try
                    {
                    ...
                    catch (WebException ex)
                    {
                        if (ex.Status == WebExceptionStatus.ProtocolError)
                        {
                            ...
                            if (response.StatusCode == HttpStatusCode.NotFound)
                            {
                                DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.provisional);
                            }
                        }
                    }
                    if (summonerInfo.summonerLevel == 30 && DivisionResult != "")
                    {
                        ...
                        foreach (Division div in divisions)
                        {
                            if (div.queue == "RANKED_SOLO_5x5")
                            {
                                ...
                                {
                                    case "BRONZE":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.bronze);
                                        break;
                                    case "SILVER":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.silver);
                                        break;
                                    case "GOLD":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.gold);
                                        break;
                                    case "PLATINUM":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.platinum);
                                        break;
                                    case "DIAMOND":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.diamond);
                                        break;
                                    case "MASTER":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.master);
                                        break;
                                    case "CHALLENGER":
                                        DivisionImage = new Bitmap(Metro_WInForm.Properties.Resources.challenger);
                                        break;
                                }
                            }
                        }
